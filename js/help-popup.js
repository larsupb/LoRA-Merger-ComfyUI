...
// and kijai's KJ nodes https://github.com/kijai/ComfyUI-KJNodes

const categories = ["LoRA PowerMerge"];
app.registerExtension({
    name: "LoRAPowerMerge.HelpPopup",
    async beforeRegisterNodeDef(nodeType, nodeData) {

        if (app.ui.settings.getSettingValue("LoRAPowerMerge.helpPopup") === false) {
            return;
        }
        try {
            ...
            console.error("Error in registering LoRAPowerMerger.HelpPopup", error);
        }
    },
});

const create_documentation_stylesheet = () => {
    const tag = 'pm-documentation-stylesheet'
...
export const addDocumentation = (
    ...
    nodeType.prototype.onDrawForeground = function (ctx) {
        ...
        if (this.show_doc && docElement === null) {
            ...
            docElement.classList.add('pm-documentation-popup')
